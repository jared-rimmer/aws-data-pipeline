...
def test_generate_new_file_name():
    result = set_source_file_name(
        latest_file={"version": "abc-123-xyz-987", "file_name": "trades.csv"}
    )
...
def test_generate_new_file_name_with_int_version():
    result = set_source_file_name(
        latest_file={"version": 1234, "file_name": "trades.csv"}
    )
...
def test_set_latest_source_files_in_s3():
    ...
    assert result == [
        {
            "version": "abc-123-xyz-987",
            "file_name": "trades.csv",
            "source_file_name": "abc-123-xyz-987-trades.csv",
        },
        {
            "version": "xyz-987-abc-123",
            "file_name": "trades.csv",
            "source_file_name": "xyz-987-abc-123-trades.csv",
        },
    ]
